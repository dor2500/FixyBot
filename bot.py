...
def get_system_prompt() -> str:
    ...
    prompt = (
        ...
        f"   א. חובה להשתמש בחיפוש Google כדי למצוא את החומרה המודרנית והעדכנית ביותר לשנת {current_date[:4]}. "
        "לדוגמה: למפרטי מחשב השתמש במעבדים מהדורות האחרונים בלבד (כגון Intel Core דור 14/15 או AMD Ryzen 7000/9000), וכרטיסי מסך מודרניים (כגון NVIDIA RTX 4000/5000 או AMD Radeon RX 7000/8000). "
        "אסור בשום אופן להמליץ על חומרה מיושנת או חלקים שירדו מהמדפים, אלא אם המשתמש ביקש במפורש רכיבים ישנים או יד שנייה.\n"
        "   ב. להציג השוואה או מפרט מסודר בפורמט הבא:\n"
        "      🏆 <b>המלצות / מפרט – עדכני ל-[חודש/שנה]</b>\n\n"
